...
class clientController extends Controller
{
    ...
    public function createClient(Request $request){
        ...
        $next_id = client_base::withoutGlobalScopes()->max('client_code') + 1;
        $display_client_code = client_base::max('display_client_code') + 1;
        $input['client_code'] = $next_id;
        $input['display_client_code'] = $display_client_code;
        ...
        return response()->json(['message'=>'Client Created','success' => true,'data' => json_decode(json_encode([], JSON_FORCE_OBJECT))]);
