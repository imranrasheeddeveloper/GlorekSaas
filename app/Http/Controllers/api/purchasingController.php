...
class purchasingController extends Controller
{
    ...
    public function createPurchase(Request $request){
        ...
        $input = $request->all();
        $display_id = purchasing::max('display_id') + 1;
        $input['grandTotal'] = '0';
    ...
    public function getPurchaseList(Request $request){
        ...
        $resourceRecords = purchasing::where(DB::raw("CONCAT(`id`, ' ', `purchaseType`, ' ', `grandTotal`, ' ', `date`)"), 'LIKE', "%" . $request->searchTerm . "%")->latest()->get();
