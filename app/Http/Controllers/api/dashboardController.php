...
class dashboardController extends Controller
{
    public function dashboardStats(Request $request){
            ...
            {
                $tmpStat['icon'] = 'ListIcon';
                $tmpStat['color'] = 'light-info';
                $tmpStat['title'] = Company::count();
                $tmpStat['subtitle'] = 'Total Companies';
                ...
                $tmpStat['color'] = 'light-info';
                $tmpStat['title'] = User::where('role', CompanyAdminRoleRef())->count();
                $tmpStat['subtitle'] = 'Total Owners';
                $tmpStat['customClass'] = 'mb-2 ';
                ...
                $tmpStat['title'] = User::where('company_id',null)->where('role', CompanyAdminRoleRef())->count();;
                $tmpStat['subtitle'] = 'Unasigned Owners';
                $tmpStat['customClass'] = 'mb-2 ';
