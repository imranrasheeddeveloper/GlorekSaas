...
class accommodationExport implements FromCollection, WithHeadings
{
    ...
    */
    ...
    {
        return ["ID", "Name", "Location", "Address", "Rooms", "Beds", "Contact Start Date", "Contact End Date", "Rent", "Services", "Due Date", "Period", "Apartment", "Electricity Account No", "Water Bill Account No", "Contact Name", "Contact Number", "Account Name", "Bank Name", "IBAN", "Fixed Electricity Amount", "Fixed Water Amount"];
    }}
