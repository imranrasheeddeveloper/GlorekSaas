                      ...
                      <b-row>
                        ...
                        <b-col cols="6">
                          <b-button
                            ...
                            size="sm"
                            variant="primary"
                            :href="'/api/resourceCsv?searchTerm='+ searchTerm+' &amp;limit='+exportLimit"
                            target = '_blank'
                          >
                            <feather-icon icon="DownloadIcon" />
                          </b-button>
        ...
        <template #cell(Options)="row">
          <div >
              ...
              <div class="d-flex justify-content-start">
                <b-button
                    v-if="$ability.can('edit', 'resource')"
                    :to="{ name: 'allocated-resource-edit', params: { id: row.item.id }}"
                ...
                <b-button
                    v-if="$ability.can('delete', 'resource')"
                    v-ripple.400="'rgba(40, 199, 111, 0.15)'"
                    variant="flat-danger"
                    class="btn-icon rounded-circle"
...
export default {
  ...
  data() {
    return {
      ...
      exportLimit:'',
      isBusy : true,
      fields: [{ key: 'Options', thClass: 'customHead' },  {key:'ownerType',sortable: true,thClass: 'customHead'},{key:'resourceOwner',sortable: true,thClass: 'customHead'},{key:'signature',sortable: true,thClass: 'customHead'},{key:'attachment',sortable: true,thClass: 'customHead'},{key:'notes',sortable: true,thClass: 'customHead'},{key:'date',sortable: true,thClass: 'customHead'}],
   ...
   methods: {
    ...
    getResourceItems() {
      ...
      getEmployees(){
        ...
        axios.get('/getAllocatedResources', {
            params: {
