        ...
        <template #cell(Action)="row">
          <div >
                ...
                <b-button
                    ...
                    :to="{ name: 'resource-item-edit', params: { id: row.item.value , resourceType: 'Accommodation'}}"
                ...
                <b-button
                    ...
                    variant="flat-danger"
                    class="btn-icon rounded-circle"
                    @click="deleteAllocation(row.item.value)"
                  >
...
export default {
  ...
  data() {
    ...
    tdClass: 'text-center'}, {key:'text',label:'Name',thClass: 'text-center customHead',
