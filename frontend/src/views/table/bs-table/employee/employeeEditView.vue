        ...
        <b-row>
          ...
          <b-col md="12">
            <b-row>
              ...
              <b-col md="2">
                <enlargeable-image v-if="formValues.ui_emp_photo" :src="formValues.ui_emp_photo" :src_large="formValues.ui_emp_photo" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="formValues.ui_emp_photo" />
                </enlargeable-image>

              </b-col>

              <b-col md="4" v-if="formValues.ui_emp_photo">
                <b-button 
                  v-ripple.400="'rgba(234, 84, 85, 0.15)'"
                  variant="outline-danger"
                  class="mt-0 mt-md-2 ml-0"
                  @click="removeImage('emp_photo')"
                >
                  <feather-icon
                    icon="XIcon"
                    class="mr-25"
        ...
        <b-row>
          ...
          <b-col md="12">
            <b-row>
              ...
              <b-col md="2" v-if="isPdf(formValues.ui_iqama)" >

                            <a class="btn btn-primary" :href="formValues.ui_iqama" target="_blank">View file</a>
              </b-col>
              <b-col md="2" v-else>
                <enlargeable-image v-if="formValues.ui_iqama" :src="formValues.ui_iqama" :src_large="formValues.ui_iqama" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="formValues.ui_iqama" />
                </enlargeable-image>
              </b-col>

              <b-col md="4" v-if="formValues.ui_iqama">
                <b-button 
                  v-ripple.400="'rgba(234, 84, 85, 0.15)'"
                  variant="outline-danger"
                  class="mt-0 mt-md-2 ml-0"
                  @click="removeImage('iqama')"
                >
                  <feather-icon
                    icon="XIcon"
                    class="mr-25"
          ...
          <b-col md="12">
            <b-row>
              ...
              <b-col md="2" v-if="isPdf(formValues.ui_passport)" >

                            <a class="btn btn-primary" :href="formValues.ui_passport" target="_blank">View file</a>
              </b-col>
              <b-col md="2" v-else>
                <enlargeable-image v-if="formValues.ui_passport" :src="formValues.ui_passport" :src_large="formValues.ui_passport" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="formValues.ui_passport" />
                </enlargeable-image>
              ...
              <b-col md="4" v-if="formValues.ui_passport">
                <b-button 
                  v-ripple.400="'rgba(234, 84, 85, 0.15)'"
                  variant="outline-danger"
                  class="mt-0 mt-md-2 ml-0"
                  @click="removeImage('passport')"
                >
                  <feather-icon
                    icon="XIcon"
                    class="mr-25"
          ...
          <b-col md="12">
            <b-row>
              ...
              <b-col md="2" v-if="isPdf(formValues.ui_passport_2)" >

                            <a class="btn btn-primary" :href="formValues.ui_passport_2" target="_blank">View file</a>
              </b-col>
               <b-col md="2" v-else>
                <enlargeable-image v-if="formValues.ui_passport_2" :src="formValues.ui_passport_2" :src_large="formValues.ui_passport_2" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="formValues.ui_passport_2" />
                </enlargeable-image>
              </b-col>

              <b-col md="4" v-if="formValues.ui_passport_2">
                <b-button 
                  v-ripple.400="'rgba(234, 84, 85, 0.15)'"
                  variant="outline-danger"
                  class="mt-0 mt-md-2 ml-0"
                  @click="removeImage('passport_2')"
                >
                  <feather-icon
                    icon="XIcon"
                    class="mr-25"
          ...
          <b-col md="12">
            <b-row>
              ...
              <b-col md="2" v-if="isPdf(formValues.ui_ajeer)" >

                            <a class="btn btn-primary" :href="formValues.ui_ajeer" target="_blank">View file</a>
              </b-col>
              <b-col md="2" v-else>
                <enlargeable-image v-if="formValues.ui_ajeer" :src="formValues.ui_ajeer" :src_large="formValues.ui_ajeer" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="formValues.ui_ajeer" />
                </enlargeable-image>
              </b-col>

              <b-col md="4" v-if="formValues.ui_ajeer">
                <b-button 
                  v-ripple.400="'rgba(234, 84, 85, 0.15)'"
                  variant="outline-danger"
                  class="mt-0 mt-md-2 ml-0"
                  @click="removeImage('ajeer')"
                >
                  <feather-icon
                    icon="XIcon"
                    class="mr-25"
          ...
          <b-col md="12">
            <b-row>
              ...
              <b-col md="2" v-if="isPdf(formValues.ui_insurance_card)" >

                            <a class="btn btn-primary" :href="formValues.ui_insurance_card" target="_blank">View file</a>
              </b-col>
              <b-col md="2" v-else>
                <enlargeable-image v-if="formValues.ui_insurance_card" :src="formValues.ui_insurance_card" :src_large="formValues.ui_insurance_card" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="formValues.ui_insurance_card" />
                </enlargeable-image>
              </b-col>

              <b-col md="4" v-if="formValues.ui_insurance_card">
                <b-button 
                  v-ripple.400="'rgba(234, 84, 85, 0.15)'"
                  variant="outline-danger"
                  class="mt-0 mt-md-2 ml-0"
                  @click="removeImage('insurance_card')"
                >
                  <feather-icon
                    icon="XIcon"
                    class="mr-25"
    ...
    removeImage(imageColumn){
        ...
        if (result.value) {
            ...
            axios.post('/deleteImage', {
                  tableName: 'employee',
                  uniqueColumn: 'emp_id',
                  uniqueValue: this.$route.params.empId,
          ...
          axios.get('/getEmployeeDetail', {
            ...
            if(response.data.hasOwnProperty('success'))
            {
              if(response.data.success === true)
              {
                ...
                this.formValues.emp_id = response.data.data.emp_id;
                this.formValues.nationality = response.data.data.nationality;
                this.formValues.religion = response.data.data.religion;
                this.formValues.dob = response.data.data.dob;
               
                this.formValues.contact_number = response.data.data.contact_number;
                this.formValues.joining_date = response.data.data.joining_date;

                this.formValues.benefits = response.data.data.benefits;
                this.formValues.iban = response.data.data.iban;
                this.formValues.vacation_date = response.data.data.vacation_date;
                this.formValues.notes = response.data.data.notes;

                this.formValues.iqama_no = response.data.data.iqama_no;
                this.formValues.iqama_expiry_date = response.data.data.iqama_expiry_date;
                this.formValues.iqama_profession = response.data.data.iqama_profession;
                this.formValues.passport_number = response.data.data.passport_number;
                this.formValues.passport_expiry_date = response.data.data.passport_expiry_date;
                this.formValues.ajeer_expiration_date = response.data.data.ajeer_expiration_date;
                this.formValues.insurance_card_expirationDate = response.data.data.insurance_card_expirationDate;

                this.formValues.vendor = response.data.data.vendor;
                this.formValues.salary_rate = response.data.data.salary_rate;

                this.formValues.client = response.data.data.client;
                this.formValues.status = response.data.data.status;
                this.formValues.accommodation = response.data.data.accommodation;
                this.formValues.contract_start = response.data.data.contract_start;
                this.formValues.project_stop_date = response.data.data.project_stop_date;

                this.formValues.lang_eng = response.data.data.lang_eng;
                this.formValues.lang_ar = response.data.data.lang_ar;
                this.formValues.lang_hind = response.data.data.lang_hind;
                this.formValues.appearance_presentable = response.data.data.appearance_presentable;
                this.formValues.apprearance_beard = response.data.data.apprearance_beard;
                this.formValues.skills = response.data.data.skills;
                this.formValues.misconduct = response.data.data.misconduct;

                this.formValues.ui_emp_photo = response.data.data.emp_photo;
                this.formValues.ui_iqama = response.data.data.iqama;
                this.formValues.ui_passport = response.data.data.passport;
                this.formValues.ui_passport_2 = response.data.data.passport_2;
                this.formValues.ui_insurance_card = response.data.data.insurance_card;
                this.formValues.ui_ajeer = response.data.data.ajeer;
