        ...
        <b-row>
          ...
          <b-col md="12">
            <b-row>
              ...
              <b-col md="6" v-if="isPdf(formValues.ui_iqama)" >
          ...
          <b-col md="12">
            <b-row>
              ...
              <b-col md="6" v-if="isPdf(formValues.ui_passport)" >
          ...
          <b-col md="12">
            <b-row>
              ...
              <b-col md="6" v-if="isPdf(formValues.ui_passport_2)" >
          ...
          <b-col md="12">
            <b-row>
              ...
              <b-col md="6" v-if="isPdf(formValues.ui_ajeer)" >
          ...
          <b-col md="12">
            <b-row>
              ...
              <b-col md="6" v-if="isPdf(formValues.ui_insurance_card)" >
