<template>
  <b-form @submit.prevent>
    <b-row>
      ...
      <b-col md="2" v-if="isPdf(ui_cr_file)" >

                            <a class="btn btn-primary mt-md-2" :href="ui_cr_file" target="_blank">View file</a>
              </b-col>
        <b-col md="2" v-else>
                <enlargeable-image v-if="ui_cr_file" :src="ui_cr_file" :src_large="ui_cr_file" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="ui_cr_file" />
                </enlargeable-image>
              </b-col>

        <b-col md="4" v-if="ui_cr_file">
                <b-button 
      ...
      <b-col md="2" v-if="isPdf(ui_vat_file)" >

                            <a class="btn btn-primary mt-md-2" :href="ui_vat_file" target="_blank">View file</a>
              </b-col>
        <b-col md="2" v-else>
                <enlargeable-image v-if="ui_vat_file" :src="ui_vat_file" :src_large="ui_vat_file" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="ui_vat_file" />
                </enlargeable-image>
              </b-col>

        <b-col md="4" v-if="ui_vat_file">
                <b-button 
                  v-ripple.400="'rgba(234, 84, 85, 0.15)'"
                  variant="outline-danger"
                  class="mt-0 mt-md-2 ml-0"
      ...
      <b-col md="2" v-if="isPdf(ui_contract)" >

                            <a class="btn btn-primary mt-md-2" :href="ui_contract" target="_blank">View file</a>
              </b-col>
        <b-col md="2" v-else>
                <enlargeable-image v-if="ui_contract" :src="ui_contract" :src_large="ui_contract" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="ui_contract" />
                </enlargeable-image>
              </b-col>

        <b-col md="4" v-if="ui_contract">
                <b-button 
                  v-ripple.400="'rgba(234, 84, 85, 0.15)'"
                  variant="outline-danger"
                  class="mt-0 mt-md-2 ml-0"
