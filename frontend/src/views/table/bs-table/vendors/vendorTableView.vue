                  ...
                  <b-tabs pills card horizontal>
                    ...
                    <b-tab title="Vendor Details">
                        ...
                        <b-row class="border-bottom " >
                          ...
                          <b-col cols="10">
                              <a class="btn btn-primary" v-if="isPdf(row.item.cr_file)" :href="row.item.cr_file" target="_blank">View file</a>
 

                              <enlargeable-image v-else :src="row.item.cr_file" :src_large="row.item.cr_file" animation_duration="600">
                                <b-img v-if="row.item.cr_file != ''" style="max-height: 80px;" thumbnail  :src="row.item.cr_file" />
                              </enlargeable-image>
                          </b-col>
                        </b-row>
                        ...
                        <b-row class="border-bottom " >
                          ...
                          <b-col cols="10">
                              <a class="btn btn-primary" v-if="isPdf(row.item.contract)" :href="row.item.contract" target="_blank">View file</a>
 

                              <enlargeable-image v-else :src="row.item.contract" :src_large="row.item.contract" animation_duration="600">
                                <b-img v-if="row.item.contract != ''" style="max-height: 80px;" thumbnail  :src="row.item.contract" />
                              </enlargeable-image>
                          </b-col>
                        </b-row>
                        ...
                        <b-row class="border-bottom " >
                          ...
                          <b-col cols="10">
                              <a class="btn btn-primary" v-if="isPdf(row.item.vat_file)" :href="row.item.vat_file" target="_blank">View file</a>
 

                              <enlargeable-image v-else :src="row.item.vat_file" :src_large="row.item.vat_file" animation_duration="600">
                                <b-img v-if="row.item.vat_file != ''" style="max-height: 80px;" thumbnail  :src="row.item.vat_file" />
                              </enlargeable-image>
                          </b-col>
                        </b-row>
                        <b-row class="border-bottom " >
