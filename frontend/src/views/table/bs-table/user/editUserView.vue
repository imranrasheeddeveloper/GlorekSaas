<template>
  <b-form @submit.prevent>
    <b-row>
      ...
      <b-col md="6" v-if="!$ability.can('view', 'superAdmin')">
        <b-form-group
          label="User Level"
          label-for="role"
        >
  ...
  methods: {
          ...
          axios.get('/getUserDetail', {
            ...
            if(response.data.hasOwnProperty('success'))
            {
              if(response.data.success === true)
              {
                ...
                this.formValues.role = response.data.data.role_id;
    ...
    submitResource(){
          ...
          this.isSubmitting = true;
            ...
            axios.post('/updateUser', this.formValues).then((response) => {
