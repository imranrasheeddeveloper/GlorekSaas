<template>
  <b-form @submit.prevent>
    <b-row>
      ...
      <b-col md="2" v-if="isPdf(ui_purchaseOrder)" >

                            <a class="btn btn-primary mt-md-2" :href="ui_purchaseOrder" target="_blank">View file</a>
              </b-col>
        <b-col md="2" v-else>
                <enlargeable-image v-if="ui_purchaseOrder" :src="ui_purchaseOrder" :src_large="ui_purchaseOrder" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="ui_purchaseOrder" />
                </enlargeable-image>
              </b-col>

        <b-col md="4" v-if="ui_purchaseOrder">
                <b-button 
