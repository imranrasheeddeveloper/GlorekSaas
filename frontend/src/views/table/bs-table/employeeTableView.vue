    ...
    <div>
          ...
          <b-row>
            ...
            <b-col md="12">
                ...
                <b-button
                  ...
                  :href="'/api/employeeCsv?searchTerm='+ searchTerm+' &amp;limit='+exportLimit+' &amp;iqama_expiry_date='+iqama_expiry_date+' &amp;vendor='+vendor+' &amp;client='+client+' &amp;status='+exportStatus"
                  target = '_blank'
                >
      ...
      >
                    ...
                    <b-tab title="Employee Details" active>
                      <b-card-text>
                        ...
                        <b-row class="border-bottom border-left" >
                          ...
                          <b-col cols="10" v-if="isPdf(row.item.emp_photo)" >

                            <a class="btn btn-primary" :href="row.item.emp_photo" target="_blank">View file</a>


                          </b-col>
                          <b-col cols="10" v-else>

                            <enlargeable-image :src="row.item.emp_photo" :src_large="row.item.emp_photo" animation_duration="600">
                              <b-img style="max-height: 80px;" thumbnail  :src="row.item.emp_photo" />
                            </enlargeable-image>
                      ...
                      <b-card-text>
                        ...
                        <b-row class="border-bottom border-left" >
                          ...
                          <b-col cols="10">
                              ...
                              >
                                {{ row.item.iqamaExpireVarient['iqama_expiry_date'] | moment("DD/MM/YYYY") }}
                              </b-badge>
                        ...
                        <b-row class="border-bottom border-left " >
                          ...
                          <b-col cols="10" v-if="isPdf(row.item.iqama)" >

                            <a class="btn btn-primary" :href="row.item.iqama" target="_blank">View file</a>


                          </b-col>
                          <b-col cols="10" v-else>

                            <enlargeable-image :src="row.item.iqama" :src_large="row.item.iqama" animation_duration="600">
                              <b-img style="max-height: 80px;" thumbnail  :src="row.item.iqama" />
                            </enlargeable-image>
                        ...
                        <b-row class="border-bottom border-left" >
                          ...
                          <b-col cols="10">
                              ...
                              <b-badge
                                pill
                                :variant="row.item.passportExpireVarient['dateVariant']"
                              >
                                {{ row.item.passportExpireVarient['passport_expiry_date'] | moment("DD/MM/YYYY") }}
                              </b-badge>
                          </b-col>
                        </b-row>
                        <b-row class="border-bottom border-left " >
                          ...
                          <b-col cols="10" v-if="isPdf(row.item.passport)" >

                            <a class="btn btn-primary" :href="row.item.passport" target="_blank">View file</a>


                          </b-col>
                          <b-col cols="10" v-else >
                            <enlargeable-image :src="row.item.passport" :src_large="row.item.passport" animation_duration="600">
                              <b-img style="max-height: 80px;" thumbnail  :src="row.item.passport" />
                            </enlargeable-image>
                          </b-col>
                        </b-row>
                        <b-row class="border-bottom border-left " >
                          ...
                          <b-col cols="10" v-if="isPdf(row.item.passport_2)" >

                            <a class="btn btn-primary" :href="row.item.passport_2" target="_blank">View file</a>


                          </b-col>
                          <b-col cols="10" v-else>

                            <enlargeable-image :src="row.item.passport_2" :src_large="row.item.passport_2" animation_duration="600">
                              <b-img style="max-height: 80px;" thumbnail  :src="row.item.passport_2" />
                            </enlargeable-image>
                        ...
                        <b-row class="border-bottom border-left " >
                          ...
                          <b-col cols="10" v-if="isPdf(row.item.ajeer)" >

                            <a class="btn btn-primary" :href="row.item.ajeer" target="_blank">View file</a>


                          </b-col>
                          <b-col cols="10" v-else>

                            <enlargeable-image :src="row.item.ajeer" :src_large="row.item.ajeer" animation_duration="600">
                              <b-img style="max-height: 80px;" thumbnail  :src="row.item.ajeer" />
                            </enlargeable-image>
                        ...
                        <b-row class="border-bottom border-left" >
                          ...
                          <b-col cols="10">
                              ...
                              >
                                {{ row.item.ajeerExpireVarient['ajeer_expiration_date'] | moment("DD/MM/YYYY") }}
                              </b-badge>
                          </b-col>
                        </b-row>
                        <b-row class="border-bottom border-left " >
                          ...
                          <b-col cols="10" v-if="isPdf(row.item.insurance_card)" >

                            <a class="btn btn-primary" :href="row.item.insurance_card" target="_blank">View file</a>
                          ...
                          <b-col cols="10" v-else>
                            ...
                            <enlargeable-image :src="row.item.insurance_card" :src_large="row.item.insurance_card" animation_duration="600">
                              <b-img style="max-height: 80px;" thumbnail  :src="row.item.insurance_card" />
                            </enlargeable-image>
                        ...
                        <b-row class="border-bottom border-left" >
                          ...
                          <b-col cols="10">
                            ...
                            <b-badge
                                pill
                                :variant="row.item.insuranceExpireVarient['dateVariant']"
                              >
                                {{ row.item.insuranceExpireVarient['insurance_card_expirationDate'] | moment("DD/MM/YYYY") }}
                              </b-badge>
                          </b-col>
                        </b-row>
                      </b-card-text>
                        ...
                        <b-row class="border-bottom border-left" >
                          ...
                          <b-col cols="10">
                              <b-list-group horizontal>
                                <b-list-group-item v-for="oneSkill in row.item.skills" :key="oneSkill">{{oneSkill}}</b-list-group-item>
        ...
        <template #cell(iqama)="data">
          ...
          <enlargeable-image :src="data.value" :src_large="data.value" animation_duration="600">
        ...
        <template #cell(iqamaExpireVarient)="data">
          <b-badge
            pill
            :variant="data.value['dateVariant']"
          >
  ...
  mounted () {
   ...
   methods: {
      ...
      statusVariant(status){
        ...
        else if(status == 'Runaway'|| status == 'Exit' || status == 'Terminated') 
          {
            return 'danger';
          }
