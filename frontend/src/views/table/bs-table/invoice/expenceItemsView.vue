                      ...
                      <b-row>
                        ...
                        <b-col cols="6">
                          <b-button
                            ...
                            size="sm"
                            variant="primary"
                            :href="'/api/expenceItemCsv?searchTerm='+ searchTerm+' &amp;limit='+exportLimit"
                            target = '_blank'
                          >
                            <feather-icon icon="DownloadIcon" />
                          </b-button>
      ...
      >
        <template #cell(Action)="row">
          <div >
                ...
                <b-button
                    v-if="$ability.can('edit', 'resource_item')"
                    :to="{ name: 'expence-item-edit', params: { id: row.item.id}}"
...
export default {
  ...
  data() {
    return {
      ...
      exportLimit:'',
      isBusy : true,
      fields: [{key:'Action',label:'Action',thClass: 'text-center customHead',
    tdClass: 'text-center'},{key:'id',label:'ID',thClass: 'text-center customHead',
    tdClass: 'text-center',sortable: true}, {key:'name',label:'Name',thClass: 'text-center customHead',
    tdClass: 'text-center',sortable: true}, {key:'name_ar',label:'Name AR',thClass: 'text-center customHead',
    tdClass: 'text-center',sortable: true}],
      items: [
      ],
      emp_detail: [
