<template>
  <b-form @submit.prevent>
    <b-row>
      ...
      <b-col md="2" v-if="isPdf(ui_invoice_copy)" >

                            <a class="btn btn-primary mt-md-2" :href="ui_invoice_copy" target="_blank">View file</a>
              </b-col>
        <b-col md="2" v-else>
                <enlargeable-image v-if="ui_invoice_copy" :src="ui_invoice_copy" :src_large="ui_invoice_copy" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="ui_invoice_copy" />
                </enlargeable-image>
              </b-col>

        <b-col md="4" v-if="ui_invoice_copy">
                <b-button 
