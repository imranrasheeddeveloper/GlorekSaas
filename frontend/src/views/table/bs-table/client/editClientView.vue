<template>
  <b-form @submit.prevent>
    <b-row>
      ...
      <b-col md="2" v-if="isPdf(ui_cr)" >

                            <a class="btn btn-primary mt-md-2" :href="ui_cr" target="_blank">View file</a>
              </b-col>
        <b-col md="2" v-else>
                <enlargeable-image v-if="ui_cr" :src="ui_cr" :src_large="ui_cr" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="ui_cr" />
                </enlargeable-image>
              </b-col>

        <b-col md="4" v-if="ui_cr">
                <b-button 
      ...
      <b-col md="2" v-if="isPdf(ui_vat_cert)" >

                            <a class="btn btn-primary mt-md-2" :href="ui_vat_cert" target="_blank">View file</a>
              </b-col>
        <b-col md="2" v-else>
                <enlargeable-image v-if="ui_vat_cert" :src="ui_vat_cert" :src_large="ui_vat_cert" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="ui_vat_cert" />
                </enlargeable-image>
              </b-col>

        <b-col md="4" v-if="ui_vat_cert">
                <b-button 
                  v-ripple.400="'rgba(234, 84, 85, 0.15)'"
                  variant="outline-danger"
                  class="mt-0 mt-md-2 ml-0"
