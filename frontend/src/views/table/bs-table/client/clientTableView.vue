                    ...
                    <b-tab title="Client Details">
                      <b-card-text>
                        ...
                        <b-row class="border-bottom  " >
                          ...
                          <b-col cols="10" v-if="isPdf(row.item.cr)" >

                            <a class="btn btn-primary" :href="row.item.cr" target="_blank">View file</a>


                          </b-col>
                          <b-col cols="10" v-else >
                            <enlargeable-image :src="row.item.cr" :src_large="row.item.cr" animation_duration="600">
                              <b-img style="max-height: 80px;" thumbnail  :src="row.item.cr" />
                            </enlargeable-image>
                          </b-col>
                        </b-row>
                        <b-row class="border-bottom  " >
                          ...
                          <b-col cols="10" v-if="isPdf(row.item.vat_cert)" >

                            <a class="btn btn-primary" :href="row.item.vat_cert" target="_blank">View file</a>


                          </b-col>
                          <b-col cols="10" v-else >
                            <enlargeable-image :src="row.item.vat_cert" :src_large="row.item.vat_cert" animation_duration="600">
                              <b-img style="max-height: 80px;" thumbnail  :src="row.item.vat_cert" />
                            </enlargeable-image>
                          </b-col>
                        </b-row>
                        <b-row class="border-bottom " >
                        ...
                        <b-row class="border-bottom  " >
                          ...
                          <b-col cols="10" v-if="isPdf(row.item.contract)" >

                            <a class="btn btn-primary" :href="row.item.contract" target="_blank">View file</a>


                          </b-col>
                          <b-col cols="10" v-else >
                            <enlargeable-image :src="row.item.contract" :src_large="row.item.contract" animation_duration="600">
                              <b-img style="max-height: 80px;" thumbnail  :src="row.item.contract" />
                            </enlargeable-image>
                          </b-col>
                        </b-row>
                        <b-row class="border-bottom " >
                        ...
                        <b-row class="border-bottom " >
                          ...
                          <b-col cols="10">
                              <b-list-group horizontal>
                                <b-list-group-item v-for="oneSkill in row.item.fat_details" :key="oneSkill">{{oneSkill}}</b-list-group-item>
...
export default {
  ...
  data() {
    return {
      ...
      exportLimit:'',
      isBusy : true,
      fields: [{ key: 'Options', thClass: 'customHead' }, {key:'display_client_code',label:'Client Code',sortable: true,thClass: 'customHead'},{key:'client_name',sortable: true,thClass: 'customHead'},{key:'contract_status',label:'Status',sortable: true,thClass: 'customHead'}],
      items: [
      ],
