<template>
  <b-form @submit.prevent>
    <b-row>
      ...
      <b-col md="2" v-if="isPdf(ui_attachment)" >

                            <a class="btn btn-primary mt-md-2" :href="ui_attachment" target="_blank">View file</a>
              </b-col>
        <b-col md="2" v-else>
                <enlargeable-image v-if="ui_attachment" :src="ui_attachment" :src_large="ui_attachment" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="ui_attachment" />
                </enlargeable-image>
              </b-col>

        <b-col md="4" v-if="ui_attachment">
                <b-button 
      ...
      <b-col md="2" v-if="isPdf(ui_rent_reciept)" >

                            <a class="btn btn-primary mt-md-2" :href="ui_rent_reciept" target="_blank">View file</a>
              </b-col>
        <b-col md="2" v-else>
                <enlargeable-image v-if="ui_rent_reciept" :src="ui_rent_reciept" :src_large="ui_rent_reciept" animation_duration="600">
                      <b-img style="max-height: 80px;" thumbnail  :src="ui_rent_reciept" />
                </enlargeable-image>
              </b-col>

        <b-col md="4" v-if="ui_rent_reciept">
                <b-button 
                  v-ripple.400="'rgba(234, 84, 85, 0.15)'"
                  variant="outline-danger"
                  class="mt-0 mt-md-2 ml-0"
