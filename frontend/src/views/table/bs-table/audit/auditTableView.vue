...
export default {
  ...
  data() {
    return {
      isBusy : true,
      fields: [{key:'id',label:'ID',sortable: true,thClass: 'customHead'},{key:'detail',label:'Detail',sortable: true,thClass: 'customHead'}, {key:'date',label:'Date',sortable: true,thClass: 'customHead'}],
      items: [
      ],
      emp_detail: [
