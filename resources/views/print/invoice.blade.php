...
<p><strong><span style="color: #fff;">{{$company ? $company->name :''}}</span></strong></p>
</td>
<td><span style="color: #035f8e;"><strong>Invoice No.</strong></span></td>
<td><span style="color: #035f8e;"><strong>{{$invoice->display_invoice_number ?? ''}}</strong></span></td>
</tr>
<tr>
<td style="background-color: #035f8e;">
<p><strong><span style="color: #fff;">VAT #&nbsp;{{$company ? $company->vat_number :''}}</span></strong></p>
</td>
...
<tr>
<td style="background-color: #ccc;"><strong>Bill Period</strong></td>
<td>{{$invoice->month ?? ''}} / {{$invoice->year ?? ''}}</td>
<td>&nbsp;</td>
<td style="text-align: right;">{{$invoice->year ?? ''}} / {{$invoice->month ?? ''}}</td>
<td style="text-align: right; background-color: #ccc;"><strong>فترة الفاتورة</strong></td>
</tr>
</tbody>
</table><br /><br />
<table style="width: 100%;" cellpadding="5px">
...
<td rowspan="4" colspan="2" >
        ...
        <table style=" margin: auto;border: 2px solid #06608f;width: 120px;text-align: center;">
            ...
            <tr>
                ...
                <td colspan="3"> <img   src="https://arabinspire.com/storage/qrImage/qrcode.svg" > </td>
...
<tr><td colspan="3" ></td></tr>
<tr>
<td style="text-align: left;" colspan="2"><span style="color: #016492;">Thank you for choosing us </span></td>
<td></td>
<td style="text-align: right;" colspan="2"><span style="color: #016492;">شكرا لك لاختيارنا</span></td>
</tr>
</tbody>
</table>
...
<td style="width: 12.5%; text-align: center; vertical-align: middle;">&nbsp;<!--<img src="https://app.gulflamar.com/images/invoice/project_sign.png" alt="" width="121" height="73" />--></td>
<td style="width: 25%; text-align: center; vertical-align: middle;">&nbsp;</td>
<td style="width: 25%; text-align: center; vertical-align: middle;">&nbsp;</td>
</tr>
<tr>
...
<td>&nbsp;</td>
<td style="border-top: 1px solid #000000; text-align: center;">Sales Department</td>
<td>&nbsp;</td>
<td style="border-top: 1px solid #000000; text-align: center;">Receiving</td>
<td>&nbsp;</td>
