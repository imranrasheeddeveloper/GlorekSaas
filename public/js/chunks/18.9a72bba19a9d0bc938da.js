...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      tmpDate: new Date(this.formValues.dob)
    };
  },
  ...
  methods: {
    ...
    formSubmitted: function formSubmitted() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_5__["default"].post('/createEmployee', formData).then(function (response) {
  ...
  computed: {
    age: function age() {
      var today = new Date();
      var age = today.getFullYear() - this.tmpDate.getFullYear();
      var m = today.getMonth() - this.tmpDate.getMonth();

      if (m < 0 || m === 0 && today.getDate() < this.tmpDate.getDate()) {
        age = age - 1;
      }
