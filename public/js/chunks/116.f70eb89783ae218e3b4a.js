      ...
      _axios__WEBPACK_IMPORTED_MODULE_5__["default"].get('/getEmployeeDetail', {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            ...
            _this2.formValues.ui_insurance_card = response.data.data.ui_insurance_card;
            _this2.formValues.ui_ajeer = response.data.data.ui_ajeer;
            console.log('done');
          } else {
            _this2.$toast({
              component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
                              ...
                              _c(
                                ...
                                [
                                  _c("b-form-file", {
                                    ...
                                    model: {
                                      value: _vm.formValues.iqama,
                                      callback: function($$v) {
                                        _vm.$set(_vm.formValues, "iqama", $$v)
                                      },
                                      expression: "formValues.iqama"
                                    }
                                  })
                                ],
                                1
