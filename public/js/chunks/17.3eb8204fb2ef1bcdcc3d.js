...
module.exports = "/images/_/_/_/_/app/frontend/src/assets/images/pages/login-v2-dark.svg";
...
module.exports = "/images/_/_/_/_/app/frontend/src/assets/images/pages/login-v2.svg";
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].login({
            ...
            localStorage.setItem('permissions', JSON.stringify(userData.ability));
