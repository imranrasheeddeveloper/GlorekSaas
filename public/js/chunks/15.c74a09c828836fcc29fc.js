  ...
  methods: {
    getRevenue: function getRevenue() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/getMonthlyRevenues', {
        ...
        _this.latestBarChart.data = response.data.data; // TODO
    ...
    refreshRevenue: function refreshRevenue(vale) {
      ...
      this.latestBarChart.data.datasets[0].data = [275, 90, 190, 56, 56, 85, 55, 87, 56, 56, 56, 34, 23];
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/getMonthlyRevenues', {
        ...
        _this2.latestBarChart.data = response.data.data; // TODO
      })["catch"](function (error) {
        console.error(error);
      });
    }
