      ...
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].post('/updateEmployee', formData).then(function (response) {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            _this.$router.replace('/employee').then(function () {
              _this.$toast({
      ...
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get('/getEmployeeDetail', {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            ...
            _this2.formValues.name = response.data.data.name;
            _this2.formValues.emp_id = response.data.data.emp_id;
            _this2.formValues.nationality = response.data.data.nationality;
            _this2.formValues.religion = response.data.data.religion;
            _this2.formValues.dob = response.data.data.dob;
            _this2.formValues.contact_number = response.data.data.contact_number;
            _this2.formValues.joining_date = response.data.data.joining_date;
            _this2.formValues.benefits = response.data.data.benefits;
            _this2.formValues.iban = response.data.data.iban;
            _this2.formValues.vacation_date = response.data.data.vacation_date;
            _this2.formValues.notes = response.data.data.notes;
            _this2.formValues.iqama_no = response.data.data.iqama_no;
            _this2.formValues.iqama_expiry_date = response.data.data.iqama_expiry_date;
            _this2.formValues.iqama_profession = response.data.data.iqama_profession;
            _this2.formValues.passport_number = response.data.data.passport_number;
            _this2.formValues.passport_expiry_date = response.data.data.passport_expiry_date;
            _this2.formValues.ajeer_expiration_date = response.data.data.ajeer_expiration_date;
            _this2.formValues.insurance_card_expirationDate = response.data.data.insurance_card_expirationDate;
            _this2.formValues.vendor = response.data.data.vendor;
            _this2.formValues.salary_rate = response.data.data.salary_rate;
            _this2.formValues.client = response.data.data.client;
            _this2.formValues.status = response.data.data.status;
            _this2.formValues.accommodation = response.data.data.accommodation;
            _this2.formValues.contract_start = response.data.data.contract_start;
            _this2.formValues.project_stop_date = response.data.data.project_stop_date;
            _this2.formValues.lang_eng = response.data.data.lang_eng;
            _this2.formValues.lang_ar = response.data.data.lang_ar;
            _this2.formValues.lang_hind = response.data.data.lang_hind;
            _this2.formValues.appearance_presentable = response.data.data.appearance_presentable;
            _this2.formValues.apprearance_beard = response.data.data.apprearance_beard;
            _this2.formValues.skills = response.data.data.skills;
            _this2.formValues.misconduct = response.data.data.misconduct;
            _this2.formValues.ui_emp_photo = response.data.data.emp_photo;
            _this2.formValues.ui_iqama = response.data.data.iqama;
            _this2.formValues.ui_passport = response.data.data.passport;
            _this2.formValues.ui_passport_2 = response.data.data.passport_2;
            _this2.formValues.ui_insurance_card = response.data.data.insurance_card;
            _this2.formValues.ui_ajeer = response.data.data.ajeer;
            console.log('done');
          } else {
            _this2.$toast({
              component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
    ...
    getAccommodations: function getAccommodations() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get('/accommodationsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);
            _this5.accommodations = response.data.data;
    ...
    getProfessions: function getProfessions() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_8__["default"].get('/professionsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);
            _this6.professions = response.data.data;
