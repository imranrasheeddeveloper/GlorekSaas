...
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _addEmployeeView_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _addEmployeeView_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _addEmployeeView_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addEmployeeView.vue?vue&type=style&index=0&lang=css& */ "./frontend/src/views/table/bs-table/employee/addEmployeeView.vue?vue&type=style&index=0&lang=css&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    dobContext: function dobContext(ctx) {
      this.formValues.dob = ctx.selectedYMD;
    },
    addLoading: function addLoading() {
      var accordionItems = _toConsumableArray(document.getElementsByClassName('wizard-btn'));
    ...
    formSubmitted: function formSubmitted() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post('/createEmployee', formData).then(function (response) {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get('/vendorsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            ...
            _this2.vendors = response.data.data;
    ...
    getAccommodations: function getAccommodations() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get('/accommodationsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);
            _this4.accommodations = response.data.data;
    ...
    getProfessions: function getProfessions() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get('/professionsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);
            _this5.professions = response.data.data;
