...
/* harmony import */ var _axios__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @axios */ "./frontend/src/libs/axios.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    BFormRating: bootstrap_vue__WEBPACK_IMPORTED_MODULE_6__["BFormRating"],
  ...
  methods: {
    formSubmitted: function formSubmitted() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].post('/updateEmployee', formData).then(function (response) {
    ...
    getEmployeeDetail: function getEmployeeDetail() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get('/getEmployeeDetail', {
        params: {
    ...
    getVendors: function getVendors() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get('/vendorsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
    ...
    getClients: function getClients() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get('/clientsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);
    ...
    getAccommodations: function getAccommodations() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get('/accommodationsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);
    ...
    getProfessions: function getProfessions() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_7__["default"].get('/professionsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);
                              ...
                              _vm.formValues.ui_emp_photo
                                ? _c(
                                    "b-button",
                                    {
                                      ...
                                      on: {
                                        click: function($event) {
                                          return _vm.removeItem(_vm.index)
                                        }
                                      }
                                    },
                                    [
