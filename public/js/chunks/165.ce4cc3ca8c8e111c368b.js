      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/getEmployeeDetail', {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            ...
            _this.formValues.name = response.data.data.emp_id;
            _this.formValues.name = response.data.data.nationality;
            _this.formValues.name = response.data.data.religion;
            _this.formValues.name = response.data.data.dob;
            _this.formValues.name = response.data.data.age;
            _this.formValues.name = response.data.data.contact_number;
            _this.formValues.name = response.data.data.joining_date;
            _this.formValues.name = response.data.data.emp_photo;
          } else {
            _this.$toast({
              component: _core_components_toastification_ToastificationContent_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
              position: 'top-right',
