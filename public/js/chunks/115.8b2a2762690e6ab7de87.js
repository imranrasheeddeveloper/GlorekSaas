  ...
  methods: {
    ...
    getEmployees: function getEmployees() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_1__["default"].get('/getemployee', {
        ...
        _this2.isBusy = false;
        var file = '/storage/upload/filter.pdf';
        var output = file.substr(file.lastIndexOf('.') + 1) == 'pdf';
        console.log('file format', output); // TODO
      })["catch"](function (error) {
        console.error(error);
      });
    },
                                      ...
                                      [
                                        ...
                                        _c(
                                          ...
                                          [
                                            ...
                                            _vm._v(" "),
                                            row.item.passport.substr(
                                              row.item.passport.lastIndexOf(
                                                "."
                                              ) + 1
                                            ) == "pdf"
                                              ? _c(
