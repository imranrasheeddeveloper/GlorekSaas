...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      isBusy: true,
      fields: ['show_details', 'name', 'emp_id', 'nationality', 'religion', 'dob', 'joining_date', 'age', 'contact_number', {
        key: 'emp_photo',
        label: 'Profile Photo'
      }, 'benefits', 'iban', 'vacation_date', 'notes', 'iqama_no', 'iqama_expiry_date', 'iqama_profession', 'iqama', 'passport_number', 'passport_expiry_date', 'passport', 'passport_2', 'ajeer', 'ajeer_expiration_date', 'insurance_card', 'insurance_card_expirationDate', 'vendor', 'salary_rate', 'client', 'status', 'accommodation', 'contract_start', 'project_stop_date', {
        key: 'lang_eng',
  ...
  methods: {
    ...
    getEmployeeDetail: function getEmployeeDetail(item) {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_1__["default"].get('/getEmployeeDetail', {
        params: {
          emp_id: item.item.emp_id
        }
      }).then(function (response) {
        if (response.data.hasOwnProperty('success')) {} else {
          _this2.$toast({
