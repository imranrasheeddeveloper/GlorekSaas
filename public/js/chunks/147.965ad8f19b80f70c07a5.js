...
var compatible = (/^2\./).test(!(function webpackMissingModule() { var e = new Error("Cannot find module 'vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).version);
if (!compatible) {
  !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).util.warn('VueClickaway ' + version + ' only supports Vue 2.x, and does not support Vue ' + !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).version);
}
...
function bind(el, binding, vnode) {
  ...
  if (typeof callback !== 'function') {
    if (true) {
      !(function webpackMissingModule() { var e = new Error("Cannot find module 'vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).util.warn(
        'v-' + binding.name + '="' +
...
/***/ "./frontend/node_modules/vue-context/src/js/index.js":
/*!***********************************************************!*\
  !*** ./frontend/node_modules/vue-context/src/js/index.js ***!
  \***********************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vue_context__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vue-context */ "./frontend/node_modules/vue-context/src/js/vue-context.js");
...
/***/ "./frontend/node_modules/vue-context/src/js/normalize-slot.js":
/*!********************************************************************!*\
  !*** ./frontend/node_modules/vue-context/src/js/normalize-slot.js ***!
  \********************************************************************/
...
/***/ "./frontend/node_modules/vue-context/src/js/utils.js":
/*!***********************************************************!*\
  !*** ./frontend/node_modules/vue-context/src/js/utils.js ***!
  \***********************************************************/
...
/***/ "./frontend/node_modules/vue-context/src/js/vue-context.js":
/*!*****************************************************************!*\
  !*** ./frontend/node_modules/vue-context/src/js/vue-context.js ***!
  \*****************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var vue_clickaway_index__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-clickaway/index */ "./frontend/node_modules/vue-clickaway/index.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./frontend/node_modules/vue-context/src/js/utils.js");
/* harmony import */ var _normalize_slot__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./normalize-slot */ "./frontend/node_modules/vue-context/src/js/normalize-slot.js");
