                    ...
                    "b-form-checkbox",
                    {
                      on: {
                        change: function($event) {
                          _vm.getEmployeeDetail(_vm.item)
                          row.toggleDetails
                        }
                      },
                      model: {
