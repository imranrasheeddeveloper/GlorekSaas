      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].login({
            ...
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].setToken(response.data.token);
            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_3__["default"].setRefreshToken(response.data.token);
