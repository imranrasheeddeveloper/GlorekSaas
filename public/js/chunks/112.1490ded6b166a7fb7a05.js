...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      formValues: {
        ...
        contract_start: '',
        project_stop_date: '',
        lang_eng: 'select_value',
        lang_ar: 'select_value',
        lang_hinds: 'select_value',
        appearance_presentable: 'select_value',
        apprearance_beard: '',
        skills: [],
        misconduct: '',
        ui_iqama: '',
  ...
  methods: {
    formSubmitted: function formSubmitted() {
      ...
      formData.append("iqama", this.formValues.iqama);
      formData.append("emp_id", this.formValues.emp_id);

      var _iterator = _createForOfIteratorHelper(this.formValues.entries()),
          _step;
      ...
      _axios__WEBPACK_IMPORTED_MODULE_5__["default"].get('/getEmployeeDetail', {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            ...
            _this2.formValues.lang_hinds = response.data.data.lang_hinds;
                                ...
                                ? _c(
                                    "enlargeable-image",
                                    {
                                      attrs: {
                                        ...
                                        src_large: _vm.formValues.ui_passport,
                                        animation_duration: "600"
                                      }
                                    },
                                    [
                                ...
                                ? _c(
                                    "enlargeable-image",
                                    {
                                      attrs: {
                                        ...
                                        src_large: _vm.formValues.ui_passport_2,
                                        animation_duration: "600"
                                      }
                                    },
                                    [
                          ...
                          _c("v-select", {
                            attrs: {
                              ...
                              dir: _vm.$store.state.appConfig.isRTL
                                ? "rtl"
                                : "ltr",
                              options: _vm.appearance_presentables,
                              selectable: function(option) {
                                return !option.value.includes("select_value")
                              },
                              label: "text"
