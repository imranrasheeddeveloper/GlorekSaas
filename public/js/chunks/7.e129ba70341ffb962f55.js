...
var canViewVerticalNavMenuGroup = function canViewVerticalNavMenuGroup(item) {
  console.log('item action', item.action, 'item Resource', item.resource);
  return true; // ! This same logic is used in canViewHorizontalNavMenuGroup and canViewHorizontalNavMenuHeaderGroup. So make sure to update logic in them as well
