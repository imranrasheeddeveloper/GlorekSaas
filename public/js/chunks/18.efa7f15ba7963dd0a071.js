...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    age: function age() {
      var today = new Date();
      var age = today.getFullYear() - this.formValues.dob.getFullYear();
      var m = today.getMonth() - this.formValues.dob.getMonth();

      if (m < 0 || m === 0 && today.getDate() < this.formValues.dob.getDate()) {
        age = age - 1;
      }
