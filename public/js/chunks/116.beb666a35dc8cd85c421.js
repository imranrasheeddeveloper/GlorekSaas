...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    formSubmitted: function formSubmitted() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].post('/updateEmployee', {
        ...
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            _this.$router.replace(getHomeRouteForLoggedInUser(userData.role)).then(function () {
              _this.$toast({
    ...
    getEmployeeDetail: function getEmployeeDetail() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/getEmployeeDetail', {
        params: {
    ...
    getVendors: function getVendors() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/vendorsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
    ...
    getClients: function getClients() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/clientsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);
    ...
    getAccommodations: function getAccommodations() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/accommodationsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);
    ...
    getProfessions: function getProfessions() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_4__["default"].get('/professionsDropdown').then(function (response) {
        if (response.data.hasOwnProperty('success')) {
          if (response.data.success === true) {
            console.log(response.data.data);
                      ...
                      _c(
                        ...
                        [
                          _c(
                            ...
                            { staticClass: "demo-inline-spacing" },
                            [
                              _c("b-form-checkbox", { attrs: { value: "A" } }, [
                                _vm._v(
                                  "\n                Checked\n              "
                                )
                              ]),
                              _vm._v(" "),
                              _c("b-form-checkbox", { attrs: { value: "B" } }, [
                                _vm._v(
                                  "\n                Unchecked\n              "
                                )
                              ])
