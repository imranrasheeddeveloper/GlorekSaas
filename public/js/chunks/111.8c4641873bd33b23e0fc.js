...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      codeRowDetailsSupport: _code__WEBPACK_IMPORTED_MODULE_4__["codeRowDetailsSupport"],
      empName: '',
      empId: '',
      empNationality: '',
      empReligion: '',
  ...
  methods: {
    getEmployees: function getEmployees() {
      ...
      _axios__WEBPACK_IMPORTED_MODULE_1__["default"].get('/getemployee', {
        ...
        _this.count = response.data.totalRows;
        _this.isBusy = false; // TODO
