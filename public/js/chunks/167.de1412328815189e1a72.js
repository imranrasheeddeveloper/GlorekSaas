...
!(function webpackMissingModule() { var e = new Error("Cannot find module './code'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/* harmony import */ var _diracleo_vue_enlargeable_image__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @diracleo/vue-enlargeable-image */ "./frontend/node_modules/@diracleo/vue-enlargeable-image/dist/vue-enlargeable-image.esm.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    EnlargeableImage: _diracleo_vue_enlargeable_image__WEBPACK_IMPORTED_MODULE_6__["default"],
  ...
  data: function data() {
    return {
      ...
      codeRowDetailsSupport: !(function webpackMissingModule() { var e = new Error("Cannot find module './code'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
      empName: '',
      empId: '',
      empNationality: '',
      empReligion: '',
    ...
    [
      ...
      _c(
        "b-modal",
        {
          ...
          on: {
            ok: function($event) {
              ;(_vm.page = 1), (_vm.searchTerm = ""), _vm.getEmployees()
            }
          }
        },
        [
                      ...
                      [
                        ...
                        _c(
                          "b-button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                return _vm.deleteEmployee(row.item.emp_id)
                              }
                            }
                          },
                          [
